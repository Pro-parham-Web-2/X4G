# pages.py  -  ParhamVPN v9.5
# شامل: LOGIN_HTML, DASHBOARD_HTML, get_public_page_html()

# لوگوی ParhamVPN (به‌صورت base64 داخلی، بدون نیاز به هاست خارجی)
# لوگوی مدرن و اختصاصی ParhamVPN (به‌صورت base64 داخلی)
LOGO_B64 = ""
LOGIN_HTML = r"""<!DOCTYPE html>
<html lang="fa" dir="rtl">
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>ورود · ParhamVPN</title>
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="ParhamVPN"></div>
      <div><div class="brand-name">ParhamVPN</div><div class="brand-sub">v9.5</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='PARHAMKING';document.getElementById('pw').focus()">PARHAMKING</span>
    </div>
    <form id="form">
      <div class="field">
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="ParhamVPN"></div>
    <span class="mob-title">ParhamVPN</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="ParhamVPN"></div>
    <div><div class="logo-name">ParhamVPN</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی ParhamVPN</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم ParhamVPN</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="ParhamVPN" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val"></div></div>
      </a>
      <a class="srv-tile" href="ParhamVPN" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-telegram"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">آیدی تلگرام</div><div class="srv-tile-val"></div></div>
      </a>
      <a class="srv-tile" href="ParhamVPN" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-users-group"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val"></div></div>
      </a>
      <a class="srv-tile" href="ParhamVPN" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-speakerphone"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">کانال تلگرام</div><div class="srv-tile-val"></div></div>
      </a>
      <a class="srv-tile" href="ParhamVPN" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-github"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گیت‌هاب</div><div class="srv-tile-val">/div></div>
      </a>
    </div>
  </div>
</section>
...
<script>
let isDark=localStorage.getItem('ParhamVPN-theme')!=='light';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('ParhamVPN-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="ParhamVPN"></div>
      <div><div class="brand-name">ParhamVPN</div><div class="brand-sub">v9.5</div></div>
    </div>
...
let isDark=localStorage.getItem('ParhamVPN-pub-theme')!=='light';
function applyTheme(dark){{
  document.documentElement.setAttribute('data-theme',dark?'dark':'light');
  document.getElementById('theme-icon').className='ti '+(dark?'ti-sun':'ti-moon');
}}
function toggleTheme(){{isDark=!isDark;localStorage.setItem('ParhamVPN-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
...
function renderContent(d){{
  ...
  window._ParhamVPNSubUrl  = subUrl;
  window._ParhamVPNSubName = d.name;
  window._ParhamVPNLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._ParhamVPNSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._ParhamVPNSubName + ' — کل گروه', window._ParhamVPNSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._ParhamVPNLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._ParhamVPNLinks[${{i}}].label, window._ParhamVPNLinks[${{i}}].vless)">
...
function copyAllConfigs(){{
  const links=window._ParhamVPNLinks||[];
